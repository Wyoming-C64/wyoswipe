...
void nwipe_gui_organisation_business_email( const char* );  // Edit business contact email
...
void nwipe_gui_add_customer_contact_email( char* );  // Add new customer contact email
